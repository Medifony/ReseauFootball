...
class FootballData {
   ...
   /**
     * Function returns teams from a particular competition identified by an id.
     * 
     * @param Integer $id
     * @return array
     */        
    public function findTeamsCompetitionById($id) {
    ...
    /**
     * Function returns matches from a particular competition identified by an id.
     * 
     * @param Integer $id
     * @return array
     */        
    public function findMatchsCompetitionById($id) {
