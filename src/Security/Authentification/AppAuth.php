...
class AppAuth extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        /**if($user->getIsBanned())
            $this->requestStack->getCurrentRequest()->getSession()->getFlashBag()->add("danger", "user is banned");
        */
        return $this->passwordEncoder->isPasswordValid($user, $credentials['password']) && !in_array("ROLE_BANNED", $user->getRoles()); 
    }
